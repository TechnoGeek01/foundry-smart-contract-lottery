...
contract RaffleTest is Test {
    ...
    // testCheckUpkeedReturnsTrueWhenParameteersAreGood
    ...
    function testPerformUpkeepUpdatesRaffleStateEmitsAndRequestId()
        public
    ...
    // this modifier is required as mock and real contract differ
    modifier skipFork() {
        ...
        skipFork
    {
        ...
        for (
            ...
            hoax(player, STARTING_USER_BALANCE); // hoax is prank + deal
            raffle.enterRaffle{value: entranceFee}();
        }

        uint price = entranceFee * (additionalEntrants + 1);
